...
CREATE OR REPLACE FUNCTION api.fun_auth_authorize(a_username text, a_token uuid, a_service tbl.enum_service, a_device_id text, a_device_os text, a_ip_address inet)
RETURNS table (
user_id bigint,
role tbl.enum_role
)
