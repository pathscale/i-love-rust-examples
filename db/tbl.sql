...
-- Last modification date: 2022-09-13 11:05:50.045

-- tables
-- Table: asset
CREATE TABLE tbl.asset (
                           pkey_id bigint  NOT NULL DEFAULT nextval( 'tbl.seq_asset_id' ),
...
CREATE TABLE tbl.asset_prototype (
                                     pkey_id bigint  NOT NULL DEFAULT nextval( 'tbl.seq_asset_prototype_id' ),
...
CREATE TABLE tbl.asset_tokenomics (
                                      pkey_id bigint  NOT NULL DEFAULT nextval( 'tbl.seq_asset_tokenomics_id' ),
...
CREATE TABLE tbl.asset_transfer_plan (
                                         pkey_id bigint  NOT NULL DEFAULT nextval( 'tbl.seq_asset_transfer_plan_id' ),
...
CREATE TABLE tbl.bucket (
                            pkey_id bigint  NOT NULL DEFAULT nextval( 'tbl.seq_bucket_id' ),
                            name varchar  NOT NULL,
...
-- Table: favorite_wallet
CREATE TABLE tbl.favorite_wallet (
                                     pkey_id bigint  NOT NULL DEFAULT nextval( 'tbl.seq_favorite_wallet_id' ),
                                     fkey_user bigint  NOT NULL,
                                     fkey_wallet bigint  NOT NULL,
                                     user_pkey_id bigint  NOT NULL,
                                     CONSTRAINT favorite_wallet_pk PRIMARY KEY (pkey_id)
);
...
CREATE TABLE tbl.vault_metadata (
                                    pkey_id bigint  NOT NULL DEFAULT nextval( 'tbl.seq_vault_metadata_id' ),
...
CREATE TABLE tbl.vault_wallet (
                                  pkey_id bigint  NOT NULL DEFAULT nextval( 'tbl.seq_vault_wallet_id' ),
                                  address varchar  NOT NULL,
...
CREATE TABLE tbl.wallet_blacklist (
                                      pkey_id bigint  NOT NULL DEFAULT nextval( 'tbl.seq_wallet_blacklist_id' ),
                                      network_type varchar  NOT NULL,
                                      address varchar  NOT NULL,
...
-- Reference: favourite_wallet_user (table: favorite_wallet)
ALTER TABLE tbl.favorite_wallet ADD CONSTRAINT favourite_wallet_user
    FOREIGN KEY (fkey_user)
        REFERENCES tbl."user" (pkey_id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
-- Reference: vault_wallet_favourite_wallet (table: favorite_wallet)
ALTER TABLE tbl.favorite_wallet ADD CONSTRAINT vault_wallet_favourite_wallet
    FOREIGN KEY (fkey_wallet)
        REFERENCES tbl.vault_wallet (pkey_id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
-- Sequence: seq_asset_id
CREATE SEQUENCE tbl.seq_asset_id
    NO MINVALUE
    NO MAXVALUE
    NO CYCLE
;

-- Sequence: seq_asset_prototype_id
CREATE SEQUENCE tbl.seq_asset_prototype_id
    NO MINVALUE
    NO MAXVALUE
    NO CYCLE
;

-- Sequence: seq_asset_tokenomics_id
CREATE SEQUENCE tbl.seq_asset_tokenomics_id
    NO MINVALUE
    NO MAXVALUE
    NO CYCLE
;

-- Sequence: seq_asset_transfer_plan_id
CREATE SEQUENCE tbl.seq_asset_transfer_plan_id
    NO MINVALUE
    NO MAXVALUE
    NO CYCLE
;
...
-- Sequence: seq_favorite_wallet_id
CREATE SEQUENCE tbl.seq_favorite_wallet_id
    NO MINVALUE
    NO MAXVALUE
    NO CYCLE
;
...
-- Sequence: seq_vault_metadata_id
CREATE SEQUENCE tbl.seq_vault_metadata_id
    NO MINVALUE
    NO MAXVALUE
    NO CYCLE
;

-- Sequence: seq_vault_wallet_id
CREATE SEQUENCE tbl.seq_vault_wallet_id
    NO MINVALUE
    NO MAXVALUE
    NO CYCLE
;
...
-- Sequence: seq_wallet_blacklist_id
CREATE SEQUENCE tbl.seq_wallet_blacklist_id
    NO MINVALUE
    NO MAXVALUE
    NO CYCLE
;
